...
rem 4) $(TargetDir)
rem 5) $(TargetName)
rem 6) Name-Of-Plugin-SubFolder
...
:CPPLUGIN
    ...
    set COPYLANG=%~4..\..\..\_PostBuildCopyLanguage.bat
    rem call %COPYLANG% "%1" "%3" "%4" "%5" de-DE
    rem call %COPYLANG% "%1" "%3" "%4" "%5" fr-FR
    rem call %COPYLANG% "%1" "%3" "%4" "%5" ru-RU
	call %COPYLANG% "%1" "%3" "%4" "%5" zh-CN
